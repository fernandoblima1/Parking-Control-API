...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> getOneParkingSpot(@PathVariable(value = "id") UUID id){
        ...
        if(!parkingSpotModelOptional.isPresent()){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Conflict: The parking spot was not found!");
        }
    ...
    public ResponseEntity<Object> deleteOneParkingSpot(@PathVariable(value = "id") UUID id){
        ...
        parkingSpotService.deleteOne(id);
        return ResponseEntity.status(HttpStatus.OK).body("Success: parking spot deleted!");
    }
    ...
    @DeleteMapping()
    public ResponseEntity<Object> deleteAllParkingSpots(){
        parkingSpotService.deleteAll();
        return ResponseEntity.status(HttpStatus.OK).body("Success: All parking spots deleted!");
    }
}